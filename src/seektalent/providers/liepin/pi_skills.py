...
_LIEPIN_SEARCH_ROUTE_PATTERNS = ("/search/getConditionItem", "/zhaopin/", "/lptjob/")
...
_SKILLS: dict[PiAgentTaskType, LiepinPiSkill] = {
    PiAgentTaskType.LIEPIN_SEARCH_CARDS: LiepinPiSkill(
        ...
        pre_action_allowed_route_patterns=_LIEPIN_SEARCH_ROUTE_PATTERNS,
        post_action_expected_route_patterns=_LIEPIN_SEARCH_ROUTE_PATTERNS,
        allowed_actions=(
    ...
    PiAgentTaskType.LIEPIN_DETECT_LOGIN_OR_RISK_STATE: LiepinPiSkill(
        ...
        pre_action_allowed_route_patterns=("/", "/login/", *_LIEPIN_SEARCH_ROUTE_PATTERNS),
        post_action_expected_route_patterns=("/", "/login/", *_LIEPIN_SEARCH_ROUTE_PATTERNS),
