...
```text
NodeRewardBreakdown_t = { delta_top_three, must_have_gain, new_fit_yield, novelty, usefulness, diversity, hard_constraint_violation, duplicate_penalty, cost_penalty, reward_score }
```
